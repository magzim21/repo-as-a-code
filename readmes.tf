locals {
  repo_readmes = {
    "personal-wealth-tracker" = <<-EOT
# Personal Wealth Tracker

## Mission
- Track personal wealth and income sources, including investments, savings, and expenses.
- Provide a dashboard to visualize wealth distribution and trends.
